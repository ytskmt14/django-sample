...
class DetailForm(forms.ModelForm):
    ...
    # top = forms.IntegerField(required=True)
...
class SubDetailForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ('time', 'main_content', 'hp_url', 'map_url', 'root_url', 'content1', 'content2', 'content3', 'content4', 'content5', 'content6', 'content7', 'content8', 'content9', 'content10', 'detail')
